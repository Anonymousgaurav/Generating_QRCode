package com.example.generating_qrcode;
...
public class MainActivity extends AppCompatActivity {
    ...
    {
        if (qrImage == null) {
            alert("There are no pictures yet.");
            return;
        }
    ...
    private void confirm(String msg, String yesText, final AlertDialog.OnClickListener yesListener) {
        AlertDialog dlg = new AlertDialog.Builder(self)
                ...
                .setMessage(msg)
                .setNegativeButton("Cancel it", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        dialog.dismiss();
                    }
    ...
    private void generateImage() {
        ...
        if (text.trim().isEmpty()) {
            alert("First type the data you want to make the QR Code");
            return;
        }
                ...
                try {
                    ...
                    self.runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            self.snackbar("QRCode has been createdt");
                        }
                    });
